(function() {
	...
	var song = window.location.search.substring(1);
	...
	superagent
		...
		.end(function(err, res) {
			...
			h1El.appendChild( document.createTextNode(res.body.title) );
			h1El.className = 'song';
			document.body.appendChild(h1El);

			h1El = document.createElement('h1');
			h1El.appendChild( document.createTextNode(res.body.artist) );
